// FILE: src/pages/novels/NovelFavoritesPage.tsx
...
const NovelFavoritesPage: React.FC = () => {
      ...
      <div className="flex flex-col xl:flex-row xl:items-start justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <RiHeart3Fill className="text-2xl text-red-400" />
            <h2 className="font-heading text-2xl font-bold">Favorite Novels</h2>
          </div>
          <p className="text-text-dim text-sm mt-1">{totalCount} favorite novels</p>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-2 w-full">
            ...
            <div className="flex gap-2 flex-1 min-w-[200px]">
              <SearchBar
                ...
                placeholder="Search favorite novels..."
                className="flex-1"
              />
              <button
                type="button"
      ...
      <div className="flex-1 min-h-0">
        {isLoading ? (
          ...
          <div className="h-64 flex flex-col items-center justify-center text-text-dim border-2 border-dashed border-border/50 rounded-2xl">
            <RiHeart3Fill className="text-5xl opacity-20 mb-4 text-red-400" />
            <p className="text-lg font-medium">No favorite novels yet</p>
            <p className="text-sm mt-2 opacity-60">Click the heart icon on novels to add them here.</p>
          </div>
        ) : (
          <>
            {/* 2カラムグリッド（1列2枚） */}
...
export default NovelFavoritesPage;